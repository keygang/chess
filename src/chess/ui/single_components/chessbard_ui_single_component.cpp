...
engine::window::WindowPos ChessboardUISingleComponent::get_cell(core::CellIndex cell_index) const {
...
engine::window::WindowPos ChessboardUISingleComponent::get_figure_start_pos(engine::window::WindowPos cell_pos,
